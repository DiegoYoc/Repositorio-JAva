 ...
 * @author ChocoChiwi
 */
public class JFrmSolucion8 extends javax.swing.JFrame {

    /**
     * Creates new form JFrmSolucion8
     */
    ProcesosSolucion8 objeto=new ProcesosSolucion8();
    public JFrmSolucion8() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLstEnunciado1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Solicitar un valor numérico entero y realizar lo siguiente:", "1) Mostrar la tabla de multiplicación en el formato:", "numero X 1= resultado", "2) Indicar si el valor es un número primo", "3) Indicar si el valor es un numero perfecto", "4) Mostrar en una lista los números de la serie fibonacci, ", "hasta el valor ingresado." };
    ...
    private void jBtnOpcion1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOpcion1ActionPerformed
        ...
        if (jTxtNum.getText().isEmpty()) {
            ...
            objeto.setNum(jTxtNum.getText());
           
            jLstResultado.setModel(objeto.tabla());
        }
    ...
    private void jBtnOpcion2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOpcion2ActionPerformed
        ...
        if (jTxtNum.getText().isEmpty()) {
            ...
            objeto.setPri(Integer.valueOf(jTxtNum.getText()));
           
            jLstResultado.setModel(objeto.primo());
        }
    ...
    private void jBtnOpcion3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOpcion3ActionPerformed
        ...
        if (jTxtNum.getText().isEmpty()) {
            ...
            objeto.setPerf(Integer.valueOf(jTxtNum.getText()));
           
            jLstResultado.setModel(objeto.perfecto());
        }
    ...
    private void jBtnOpcion4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOpcion4ActionPerformed
        ...
        if (jTxtNum.getText().isEmpty()) {
            ...
            objeto.setFibo(Integer.valueOf(jTxtNum.getText()));
           
            jLstResultado.setModel(objeto.secuencia());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmSolucion8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmSolucion8().setVisible(true);
            }
        });
    }
